  ...
  return (
    <div>
      <div className='main '>
        ...
        <div className='header fixed z-10 w-full h-40 bg-white shadow-md lg:px-5 md:px-5 px-3 pt-2 '>
          ...
          <div className='search flex items-center justify-between  md:gap-5 sm:gap-5 gap-6 '>
