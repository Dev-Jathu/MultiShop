    ...
    <div>
      <div className='main '>
        ...
        <div className='header fixed z-10 w-full h-40 bg-white shadow-md lg:px-5 md:px-5 px-3'>
          ...
          <div className='lg:-mt-16 md:-mt-12 search flex items-center justify-between  md:gap-5 gap-5 bottom-10 '>
            <Link
              to='/'
              className='w-[200px] '
            >
            ...
            <div className='shop lg:text-[30px] md:text-[25px] hidden lg:blog gap-12 md:gap-5 md:flex lg:flex'>
              ...
              <Link to='/category'>
                <img
                  src={Categories}
                  className=' md:h-[30px] md:w-[50px] h-[58px] lg:h-[35px] lg:w-[30px] lg:pt-2 md:pt-1'
                  alt='categories'
                />
              </Link>
              <Link to='/cart'>
