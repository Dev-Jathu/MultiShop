...
const ProductPage = () => {
  ...
  // Separate discounted products (assuming the discount can be identified by a property, e.g., `discount: true` or `discountPrice`)
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 py-5'>
        {productsToDisplay.map((product) => (
          <ProductCard
            key={product.id}
            product={product}
            // Pass 'simple' mode when 'All' is selected, otherwise 'detailed'
